        ...
        <section className="lei-body">
          <div className="container container--narrow">
            ...
            <div className="lei-justificativa">
              ...
              <p>A proposta tem um custo de implementação — integração de sistemas, treinamento e capacitação —, porém pequeno diante da economia que gera, e não cria órgão, cargo ou infraestrutura nova permanente, valendo-se dos contratos e licitações que o poder público já realiza. Em contrapartida, os ganhos são expressivos: mais segurança para o paciente, economia de recursos com a redução de exames repetidos e aproveitamento do tempo em atendimentos de urgência. Trata-se de fazer a estrutura existente render mais, e não de ampliá-la.</p>
