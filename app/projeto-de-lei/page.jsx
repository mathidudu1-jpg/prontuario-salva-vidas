        ...
        <section className="lei-body">
          <div className="container container--narrow">
            ...
            <div className="lei-justificativa">
              ...
              <p>A proposta exige um investimento inicial de implementação — desenvolvimento de integrações entre sistemas, adaptação dos prontuários eletrônicos, segurança da informação, treinamento das equipes e suporte contínuo. Esse custo, porém, é pequeno diante da economia que gera com a redução de exames repetidos e do retrabalho, e não cria estrutura administrativa nova permanente, valendo-se dos contratos e licitações que o poder público já realiza. Reconhecer esse investimento é o que dá credibilidade e viabilidade à proposta.</p>
