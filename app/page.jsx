        ...
        <section className="hero" id="topo">
          ...
          <div className="container hero-inner">
            <div className="hero-copy">
              ...
              <h1 className="hero-title" id="hero-title">E se fosse possível economizar até R$ 12 bilhões por ano e ainda salvar vidas com uma solução que já existe?<br />A resposta cabe em uma única lei.</h1>
